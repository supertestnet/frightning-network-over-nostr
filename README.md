# Frightening network over nostr
A fork of [the frightening network](https://github.com/supertestnet/frightening-network/) but instead of making users copy/paste state transition data, nostr automates some of it
